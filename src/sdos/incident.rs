...
impl From<Incident> for crate::StixObjectEnum {
    fn from(i: Incident) -> Self {
        crate::StixObjectEnum::Incident(i)
    }
}
...
mod tests {
    ...
    fn incident_builder_and_serialize() {
        ...
        assert_eq!(
            v.get("name").and_then(Value::as_str).unwrap(),
            "Test Incident"
        );
    }
}
