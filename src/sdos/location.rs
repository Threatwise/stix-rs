...
impl LocationBuilder {
    ...
    pub fn administrative_area(mut self, a: impl Into<String>) -> Self {
        self.administrative_area = Some(a.into());
        self
    }
    pub fn city(mut self, c: impl Into<String>) -> Self {
        self.city = Some(c.into());
        self
    }
    pub fn street_address(mut self, s: impl Into<String>) -> Self {
        self.street_address = Some(s.into());
        self
    }
    pub fn postal_code(mut self, p: impl Into<String>) -> Self {
        self.postal_code = Some(p.into());
        self
    }
    ...
    pub fn build(self) -> Result<Location, super::BuilderError> {
        ...
        {
            return Err(super::BuilderError::MissingField(
                "one of region|country|(latitude+longitude)",
            ));
        }
...
impl From<Location> for crate::StixObjectEnum {
    fn from(l: Location) -> Self {
        crate::StixObjectEnum::Location(l)
    }
}
