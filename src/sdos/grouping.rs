...
impl Grouping { pub fn builder() -> GroupingBuilder { GroupingBuilder::default() } }

#[derive(Debug, Default)]
pub struct GroupingBuilder { name: Option<String>, description: Option<String>, context: Option<String>, object_refs: Option<Vec<String>>, created_by_ref: Option<String> }
...
impl GroupingBuilder {
    ...
    pub fn context(mut self, c: impl Into<String>) -> Self { self.context = Some(c.into()); self }
    ...
    pub fn build(self) -> Result<Grouping, super::BuilderError> {
        let context = self.context.ok_or(super::BuilderError::MissingField("context"))?;
        ...
        Ok(Grouping{ common, name: self.name, description: self.description, context, object_refs })
    }
}

impl StixObject for Grouping { fn id(&self) -> &str { &self.common.id } fn type_(&self) -> &str { &self.common.r#type } fn created(&self) -> DateTime<Utc> { self.common.created } }

impl From<Grouping> for crate::StixObjectEnum { fn from(g: Grouping) -> Self { crate::StixObjectEnum::Grouping(g) } }
