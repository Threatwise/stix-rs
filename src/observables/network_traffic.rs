...
impl NetworkTrafficBuilder {
    pub fn start(mut self, t: DateTime<Utc>) -> Self {
        self.start = Some(t);
        self
    }
    pub fn end(mut self, t: DateTime<Utc>) -> Self {
        self.end = Some(t);
        self
    }
    pub fn protocols(mut self, p: Vec<String>) -> Self {
        self.protocols = Some(p);
        self
    }
    pub fn src_ref(mut self, r: impl Into<String>) -> Self {
        self.src_ref = Some(r.into());
        self
    }
    pub fn dst_ref(mut self, r: impl Into<String>) -> Self {
        self.dst_ref = Some(r.into());
        self
    }
...
impl From<NetworkTraffic> for crate::StixObjectEnum {
    fn from(n: NetworkTraffic) -> Self {
        crate::StixObjectEnum::NetworkTraffic(n)
    }
}
