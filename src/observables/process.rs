...
impl ProcessBuilder {
    ...
    pub fn command_line(mut self, c: impl Into<String>) -> Self {
        self.command_line = Some(c.into());
        self
    }
    pub fn created(mut self, t: DateTime<Utc>) -> Self {
        self.created = Some(t);
        self
    }
...
impl From<Process> for crate::StixObjectEnum {
    fn from(p: Process) -> Self {
        crate::StixObjectEnum::Process(p)
    }
}
