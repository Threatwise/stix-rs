...
impl MutexBuilder {
    ...
    pub fn currently_owned(mut self, v: bool) -> Self {
        self.currently_owned = Some(v);
        self
    }
    ...
    pub fn build(self) -> Mutex {
        Mutex {
            name: self.name,
            currently_owned: self.currently_owned,
            custom_properties: self.custom_properties,
        }
    }
}

impl From<Mutex> for crate::StixObjectEnum {
    fn from(m: Mutex) -> Self {
        crate::StixObjectEnum::Mutex(m)
    }
}
