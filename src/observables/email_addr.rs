...
impl EmailAddr {
    pub fn builder() -> EmailAddrBuilder {
        EmailAddrBuilder::default()
    }
}

#[derive(Debug, Default)]
pub struct EmailAddrBuilder {
    value: Option<String>,
...
impl From<EmailAddr> for crate::StixObjectEnum {
    fn from(e: EmailAddr) -> Self {
        crate::StixObjectEnum::EmailAddr(e)
    }
}
