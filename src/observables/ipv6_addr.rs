...
impl IPv6Addr {
    pub fn builder() -> IPv6AddrBuilder {
        IPv6AddrBuilder::default()
    }
}

#[derive(Debug, Default)]
pub struct IPv6AddrBuilder {
    value: Option<String>,
...
impl From<IPv6Addr> for crate::StixObjectEnum {
    fn from(i: IPv6Addr) -> Self {
        crate::StixObjectEnum::IPv6Addr(i)
    }
}
