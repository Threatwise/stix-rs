...
impl MacAddr {
    pub fn builder() -> MacAddrBuilder {
        MacAddrBuilder::default()
    }
}

#[derive(Debug, Default)]
pub struct MacAddrBuilder {
    value: Option<String>,
...
impl From<MacAddr> for crate::StixObjectEnum {
    fn from(m: MacAddr) -> Self {
        crate::StixObjectEnum::MacAddr(m)
    }
}
