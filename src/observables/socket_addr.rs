...
impl SocketAddr {
    pub fn builder() -> SocketAddrBuilder {
        SocketAddrBuilder::default()
    }
}
...
impl From<SocketAddr> for crate::StixObjectEnum {
    fn from(s: SocketAddr) -> Self {
        crate::StixObjectEnum::SocketAddr(s)
    }
}
