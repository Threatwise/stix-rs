...
impl WindowsRegistryKey {
    pub fn builder() -> WindowsRegistryKeyBuilder {
        WindowsRegistryKeyBuilder::default()
    }
}
...
impl WindowsRegistryKeyBuilder {
    ...
    pub fn values(mut self, v: std::collections::HashMap<String, String>) -> Self {
        self.values = Some(v);
        self
    }
...
impl From<WindowsRegistryKey> for crate::StixObjectEnum {
    fn from(w: WindowsRegistryKey) -> Self {
        crate::StixObjectEnum::WindowsRegistryKey(w)
    }
}
